...
from gbc import ConnectedComponentsClustering
...
class SDO:
    ...
    def fit(self, X):
        ...
        print(m)
        index = np.random.permutation(204715)
        print(index)
        O = X[index[0:k]]
        print(len(X))
...
class SDOclust:
    ...
    def __init__(self, x=5, qv=0.3, hbs=False, smooth=False, smooth_f=0.25, rseed=5, zeta=0.6, chi_min=4, chi_prop=0.05, e=3, chi=None, cb_outlierness=False, xc=None, k=None, q=None, chunksize=None):
        self.x = x
        self.qv = qv
        self.hbs = hbs
        self.smooth = smooth
        self.smooth_f = smooth_f
        self.rseed = rseed
        self.zeta = zeta  # 原 0.6
        self.chi_min = chi_min # 原 4
